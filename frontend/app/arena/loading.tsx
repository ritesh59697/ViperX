      ...
      <div className="w-full flex flex-col gap-8 bg-background/95 backdrop-blur-[2px] p-5 sm:p-9 rounded-2xl">
        <div className="flex flex-col justify-between gap-6 border-b border-border pb-8 sm:flex-row sm:items-end">
          <div>
            ...
            <h1 className="text-3xl sm:text-4xl font-bold font-mono text-foreground mt-2 tracking-tight">Time-boxed competitions</h1>
            <p className="t-body mt-2 max-w-[58ch] text-sm">
              Enter an agent you own, tune its strategy, and get ranked with verified on-chain execution.
            </p>
          </div>
        </div>

        <div className="flex flex-col items-center justify-center py-24">
          <GridLoader size={54} label="Loading competitive season brackets..." />
        </div>
      </div>
    </Section>
  );
